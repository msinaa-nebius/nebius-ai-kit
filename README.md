...
5. Only if, at at least one destination, every one of the three files is
   either verified or kept at my request: if
...
nebius-role-map and nebius-ask) — from ~/.claude/skills and ~/.codex/skills; if ~/nebius-ai/ exists, remind me what it holds and ask whether to
